...
X2_OMO_AGENT_ROUTING="${X_OC_PODMAN_X2_OMO_AGENT_ROUTING:-auto}"
X2_OMO_SIMPLE_AGENT="${X_OC_PODMAN_X2_OMO_SIMPLE_AGENT:-spark}"
X2_OMO_COMPLEX_AGENT="${X_OC_PODMAN_X2_OMO_COMPLEX_AGENT:-sisyphus}"
X2_OMO_BYPASS_AGENT="${X_OC_PODMAN_X2_OMO_BYPASS_AGENT:-}"
X2_OMO_BYPASS_MODEL="${X_OC_PODMAN_X2_OMO_BYPASS_MODEL:-}"
...
PODMAN_RUN_ARGS=(
  ...
  -e X2_OMO_AGENT_ROUTING="$X2_OMO_AGENT_ROUTING"
  -e X2_OMO_SIMPLE_AGENT="$X2_OMO_SIMPLE_AGENT"
  -e X2_OMO_COMPLEX_AGENT="$X2_OMO_COMPLEX_AGENT"
  -e X2_OMO_BYPASS_AGENT="$X2_OMO_BYPASS_AGENT"
  -e X2_OMO_BYPASS_MODEL="$X2_OMO_BYPASS_MODEL"
...
echo "SEED SOURCES:  auth=$AUTH_IMPORT_SOURCE_HOST omo=$OMO_CONFIG_SOURCE_HOST spark=$SPARK_PROMPT_SOURCE_HOST genesis=$GENESIS_PROMPT_SOURCE_HOST eq1=$EQ1_CORE_PROMPT_SOURCE_HOST x2=$X2_SUMMARIZER_PROMPT_SOURCE_HOST x4=$X4_SUMMARIZER_PROMPT_SOURCE_HOST templates=$DOC_TEMPLATES_SOURCE_HOST"

...
echo "SEED SOURCES:  auth=$AUTH_IMPORT_SOURCE_HOST omo=$OMO_CONFIG_SOURCE_HOST spark=$SPARK_PROMPT_SOURCE_HOST x2=$X2_SUMMARIZER_PROMPT_SOURCE_HOST x4=$X4_SUMMARIZER_PROMPT_SOURCE_HOST"
